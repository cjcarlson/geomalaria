...
for (run in c(1:6)) {
  ...
  if (run == 1) {
    unstablename <- 'Africa_unstable_R8_1_2020'
    stablename <- 'Africa_stable_R8_1_2020'
  ...
  if (run == 2) {
    unstablename <- 'Africa_unstable_R8_2_2020'
    stablename <- 'Africa_stable_R8_2_2020'
  ...
  if (run == 3) {
    unstablename <- 'Africa_unstable_R8_3_2020'
    stablename <- 'Africa_stable_R8_3_2020'
  ...
  if (run == 4) {
    unstablename <- 'Africa_unstable_GL_1_2020'
    stablename <- 'Africa_stable_GL_1_2020'
  ...
  if (run == 5) {
    unstablename <- 'Africa_unstable_GL_2_2020'
    stablename <- 'Africa_stable_GL_2_2020'
  ...
  if (run == 6) {
    unstablename <- 'Africa_unstable_GL_3_2020'
    stablename <- 'Africa_stable_GL_3_2020'
