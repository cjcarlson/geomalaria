...
for (run in c(1:6)) {
  ...
  if (run == 1) {
    unstablename <- 'Asia_unstable_R8_1_2020'
    stablename <- 'Asia_stable_R8_1_2020'
  ...
  if (run == 2) {
    unstablename <- 'Asia_unstable_R8_2_2020'
    stablename <- 'Asia_stable_R8_2_2020'
  ...
  if (run == 3) {
    unstablename <- 'Asia_unstable_R8_3_2020'
    stablename <- 'Asia_stable_R8_3_2020'
  ...
  if (run == 4) {
    unstablename <- 'Asia_unstable_GL_1_2020'
    stablename <- 'Asia_stable_GL_1_2020'
  ...
  if (run == 5) {
    unstablename <- 'Asia_unstable_GL_2_2020'
    stablename <- 'Asia_stable_GL_2_2020'
  ...
  if (run == 6) {
    unstablename <- 'Asia_unstable_GL_3_2020'
    stablename <- 'Asia_stable_GL_3_2020'
  ...
  write.csv(big.unstable.df, paste(unstablename,'.csv',sep=''))
  write.csv(big.stable.df, paste(stablename,'.csv',sep=''))
