...
if (run == 1) {
unstablename <- 'Africa_unstable_G3_1'
stablename <- 'Africa_stable_G3_1'
...
if (run == 2) {
unstablename <- 'Africa_unstable_G3_2'
stablename <- 'Africa_stable_G3_2'
...
if (run == 3) {
unstablename <- 'Africa_unstable_G3_3'
stablename <- 'Africa_stable_G3_3'
...
if (run == 4) {
unstablename <- 'Africa_unstable_R4_1'
stablename <- 'Africa_stable_R4_1'
...
if (run == 5) {
unstablename <- 'Africa_unstable_R4_2'
stablename <- 'Africa_stable_R4_2'
...
if (run == 6) {
unstablename <- 'Africa_unstable_R4_3'
stablename <- 'Africa_stable_R4_3'
