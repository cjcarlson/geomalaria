...
for (run in c(1:4,6)) {
  ...
  if (run == 1) {
    unstablename <- 'LatAm_unstable_R8_1'
    stablename <- 'LatAm_stable_R8_1'
  ...
  if (run == 2) {
    unstablename <- 'LatAm_unstable_R8_2'
    stablename <- 'LatAm_stable_R8_2'
  ...
  if (run == 3) {
    unstablename <- 'LatAm_unstable_R8_3'
    stablename <- 'LatAm_stable_R8_3'
  ...
  if (run == 4) {
    unstablename <- 'LatAm_unstable_GL_1'
    stablename <- 'LatAm_stable_GL_1'
  ...
  if (run == 5) {
    unstablename <- 'LatAm_unstable_GL_2'
    stablename <- 'LatAm_stable_GL_2'
  ...
  if (run == 6) {
    unstablename <- 'LatAm_unstable_GL_3'
    stablename <- 'LatAm_stable_GL_3'
